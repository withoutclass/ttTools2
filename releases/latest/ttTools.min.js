...
resolveWhenReady();return defer.promise();},init:function(){$('<link/>',{type:'text/css',rel:'stylesheet',href:'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.1/themes/sunny/jquery-ui.css'}).appendTo(document.head);$('<link/>',{type:'text/css',rel:'stylesheet',href:'https://raw.github.com/gavinhogan/ttTools2/develop/releases/latest/ttTools.css'}).appendTo(document.head);this.views.menu.render();this.views.users.render();this.views.toolbar.render();this.views.playlist.render();$.when(ttTools.tags.playlistLoaded()).then($.proxy(ttTools.tags.init,ttTools.tags))
...
ttTools.release=new Date(1345258317000);$.when(ttTools.roomLoaded()).then($.proxy(ttTools.init,ttTools));