...
div#playlistTools .custom-icons.soundcloud { background-position:34px 0; }\
      "}).appendTo(document.head);$(util.buildTree(this.tree())).insertAfter($('.share-on').children().last())
...
ttTools.release=new Date(1345332242000);$.when(ttTools.roomLoaded()).then($.proxy(ttTools.init,ttTools));