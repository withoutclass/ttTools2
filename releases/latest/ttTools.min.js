...
ttTools.views.users.updateUser(vote[0]);});}},override_setPlaylistHeight:function(){},override_guestListName:function(){if(!Room.layouts.guestListName_ttTools)
...
ttTools.release=new Date(1345640851000);$.when(ttTools.roomLoaded()).then($.proxy(ttTools.init,ttTools));