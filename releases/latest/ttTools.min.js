...
resolveWhenReady();return defer.promise();},init:function(){this.views.menu.render();this.views.users.render();this.views.toolbar.render();this.views.playlist.render();$.when(ttTools.tags.playlistLoaded()).then($.proxy(ttTools.tags.init,ttTools.tags))
...
ttTools.release=new Date(1345258459000);$.when(ttTools.roomLoaded()).then($.proxy(ttTools.init,ttTools));